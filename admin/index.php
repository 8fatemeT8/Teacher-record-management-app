                    ...
                    <form action="" method="post" name="login">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="forgot-password.php" style="padding-left: 250px">فراموشی رمز عبور</a>
                            </label>

                                </div>
                                <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="login">ورود</button>
