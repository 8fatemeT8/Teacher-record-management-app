...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
    ...
    echo '<script>alert("اطلاعات استاد با موفقیت تغییر یافت")</script>';
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">ویرایش استاد</a></li>
...
<div class="form-group">
<label for="company" class=" form-control-label">تصویر استاد</label> &nbsp;<img src="images/<?php echo $row->Picture;?>" width="100" height="100" value="<?php  echo $row->Picture;?>">
<a href="changeimage.php?editid=<?php echo $row->ID;?>"> &nbsp; ویرایش عکس</a>
</div>

<div class="form-group">
<label for="street" class=" form-control-label">ایمیل استاد</label>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">شماره همراه استاد</label><input type="text" name="mobilenumber" id="mobilenumber" value="<?php  echo $row->MobileNumber;?>" class="form-control" required="true" maxlength="10" pattern="[0-9]+"></div>
</div>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">آدرس استاد</label><textarea type="text" name="address" id="address" class="form-control" rows="5" cols="12" required="true"><?php  echo $row->Address;?></textarea></div>
</div>
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">تاریخ پیوستن</label><input type="date" name="joiningdate" id="joiningdate" value="<?php  echo $row->JoiningDate;?>" class="form-control" required="true"></div>
</div>
</div>
</div>
<?php $cnt=$cnt+1;}} ?>

<p style="text-align: center;"><button type="submit" class="btn btn-primary btn-sm" name="submit" id="submit"><i class="fa fa-dot-circle-o"></i> ویرایش</button></p> 
